...
class ServicerHelpSupportView extends StatelessWidget {
  const ServicerHelpSupportView({super.key});
            ...
            children: [
              ...
              _card(
                child: Column(
                  ...
                  children: [
                    _paragraph(
                      "If you're experiencing a technical issue, please contact us:",
                    ),
                    const SizedBox(height: 12),
              ...
              _card(
                child: Column(
                  ...
                  children: [
                    ...
                    _bullet("Check for Updates", "Make sure you have the latest version installed."),

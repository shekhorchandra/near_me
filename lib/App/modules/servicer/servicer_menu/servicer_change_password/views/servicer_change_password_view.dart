...
class ServicerChangePasswordView extends GetView<ServicerChangePasswordController> {
  const ServicerChangePasswordView({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const CommonAppBar(title: "Servicer Change Password"),
      body: Padding(

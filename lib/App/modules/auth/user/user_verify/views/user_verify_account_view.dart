...
class UserVerifyAccountView extends GetView<UserVerifyAccountController> {
  const UserVerifyAccountView({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CommonAppBar(backgroundColor: Colors.white, title: 'User Verify Account'),
      body: SafeArea(
